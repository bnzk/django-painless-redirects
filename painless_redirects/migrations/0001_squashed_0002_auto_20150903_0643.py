...
class Migration(migrations.Migration):
    ...
    replaces = [(b'painless_redirects', '0001_initial'), (b'painless_redirects', '0002_auto_20150903_0643')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('old_path', models.CharField(help_text="This should be an absolute path, excluding the domain name. Example: '/events/search/'.", max_length=333, verbose_name='From path')),
                ('wildcard_match', models.BooleanField(default=False, help_text='Add wildcard (*) to from path', verbose_name='Wildcard mode')),
                ('new_path', models.CharField(help_text='Absolute path, or full url (with http://.../).', max_length=333, verbose_name='To')),
