    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('old_path', models.CharField(help_text="This should be an absolute path, excluding the domain name. Example: '/events/search/'.", max_length=333, verbose_name='From path', db_index=True)),
